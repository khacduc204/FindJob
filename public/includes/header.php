...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" integrity="sha512-H2z8uRHFqRSbVSSMzdON3NofM8JrIoVNewc19hXtOD87bwo4V/mQJu1WDVYj1WFJsbgwe5caGV5/C/P4xGOY2w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
            ...
            <div class="collapse navbar-collapse" id="jfMainNav">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3 jf-nav-actions">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <button class="btn btn-icon position-relative" type="button" aria-label="Thông báo">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end jf-profile-menu p-0 overflow-hidden">
                                <div class="jf-profile-section">
                                    ...
                                    <a class="dropdown-item" href="<?= BASE_URL ?>/dashboard.php"><i class="fa-solid fa-gauge-high me-2"></i>Bảng điều khiển</a>
